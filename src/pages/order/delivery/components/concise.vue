        ...
        <div id="concise" v-if="list">
            <div style="display:flex;align-items:center;">
                <table border="1" id="ddd">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" class="blod">采购商名称</td>
                        ...
                        <tr>
                            <td class="blod" colspan="2">送货时间</td>
                            <td colspan="2">{{deliveryDate}}</td>
                            <td class="blod" >送货批次</td>
                            <td colspan="2">{{options[buySeq].label}}</td>
                            <td class="blod" >司机电话</td>
                            <td>{{trucks[truckIndex].telephone}}</td>
                        </tr>
                        <tr>
                            <td class="blod" colspan="5">送货地址</td>
                            <td class="blod" colspan="2">送货联系人</td>
                            <td class="blod" colspan="2">联系电话</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">备注</td>
                            <td colspan="7" class="print-hidden to-left"><el-input v-model="remarks" @change="changeRemarks"></el-input></td>
